...
public class Apple : MonoBehaviour
{
    ...
    IEnumerator BiteHaptics()
    {
        ...
        interactable.StayHaptics.Vibration.Effect = new SharpTick(NarrowThreeOptions._100){OneShot = true};
        ...
        interactable.StayHaptics.Vibration.Effect = new DoubleSharpTick(TickDuration.Short, NarrowThreeOptions._100){OneShot = true};
        yield return new WaitForSeconds(eachBiteDuration);
        interactable.StayHaptics.Vibration.Effect = VibrationEffect.None;
